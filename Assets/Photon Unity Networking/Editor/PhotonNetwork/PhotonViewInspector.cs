...
public class PhotonViewInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (sceneProp.isInstantiatedPrefab && !sceneProp.prefabOverride)
        {
            ...
            GameObject pPrefab = (PrefabUtility.GetPrefabParent(mp.gameObject) as GameObject).transform.root.gameObject;
            ...
            GameObject pPrefab2 = (PrefabUtility.GetPrefabParent(mp.gameObject) as GameObject);
            if (pPrefab2 != null)
            {
