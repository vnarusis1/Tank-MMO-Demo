...
public class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    public NetworkingPeer(
        IPhotonPeerListener listener, string playername, ConnectionProtocol connectionProtocol)
    ...
    private void HandleEventLeave(int actorID)
    {
        ...
        {
            //ts: cleans up everything (RPCs, Instantiate, anything cached by any player who left already)
            this.RemoveCacheOfLeftPlayers();
        }
    }
    ...
    public void OnEvent(EventData photonEvent)
    {
        ...
        switch (photonEvent.Code)
        {
            ...
            case PhotonNetworkMessages.Destroy:
                ...
                {
                    Debug.LogError("ERROR: Illegal destroy request on view ID=" + viewID + " from player/actorNr: " + actorNr + " view=" + view + "  orgPlayer=" + orgPlayer);
                }
                else
                {
