...
public static class PhotonNetwork
{
    ...
    static PhotonNetwork()
    {
        ...
        networkingPeer = new NetworkingPeer(photonMono, "Guest " + UnityEngine.Random.Range(1, 9999), ExitGames.Client.Photon.ConnectionProtocol.Udp);
    ...
    {
        //TODO: check if this object ".isMine"
    ...
    public static void DestroyPlayerObjects(PhotonPlayer destroyPlayer)
    {
        ...
        {
            networkingPeer.DestroyPlayerObjects(player, false);
        }
        else
        {
    ...
    public static void RemoveAllInstantiatedObjects(PhotonPlayer player)
    {
        ...
        networkingPeer.RemoveAllInstantiatedObjectsByPlayer(player, false);
    }
