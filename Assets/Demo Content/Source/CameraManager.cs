...
public class CameraManager : MonoBehaviour {
	...
	public Mode mode = Mode.MouseOrbitTarget;
	...
	{
		if ( mode == Mode.MouseOrbitTarget && orbit) 
		{
			...
			_position = _rotation * new Vector3(0.0f, 0.0f, -targetDistance) + (orbit.position + orbitOffset);
